  ...
  return (
    ...
    >
      <div className="h-[100px] text-center text-dark-ebony">
          ...
          {sidebarItems.map((item) => (
            <li key={item.title}>
              <Link
                href={item.href}
                className={cn(
                  "relative mb-3 flex h-8 flex-row items-center border-r-4 border-transparent hover:border-gray-300",
                  `${
                    router.asPath === item.href
                      ? "border-ecstasy hover:border-ecstasy"
                      : ""
                  }`
                )}
              >
                ...
                <span
                  className={cn(
                    "ml-2 truncate tracking-wide",
                    `${router.asPath === item.href ? "font-semibold" : ""}`
                  )}
                >
                  {item.title}
                </span>
        ...
        <div className="absolute bottom-20 py-3">
          <hr className="mb-5" />
          <div className="flex items-center justify-center pl-5">
            ...
            <div>
              ...
              <Button
                variant="default"
                size="sm"
                className="w-full rounded-lg bg-ecstasy text-white"
